...
/*
 *
 * x metis ß ∑∑∑∑∑ ß abcdefghijklmnopqrstuvwxyz {|}~                                        ß M290Ou ß  ∑ ß
 * x metis ß wc8∑∑ ß !"#$%&'()+*,-../ 0123456789 :;<=>?                                     ß M2875J ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß @ABCDEFGHIJKHLMNOPRSTUVWXYZ [\]^_                                      ß M294uB ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß †°¢£§•¶ ®©™´¨≠ÆØ ∞±≤≥¥µ∂∑∏π                                            ß M29Mba ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß ∫ªºΩæø–—“”‘÷’◊                                                         ß M2A4sx ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß a¿b¡c¬d√eƒf≈                                                           ß M2A5wm ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß g∆h«i»j…k lÀmÃnÕoŒ œ                                                   ß M2AL9b ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß öôŸÿ‡·‚„ÂÊÁèõò‰‹›ﬁﬂ                                                    ß M2ALQe ß  ∑ ß
 * x x metis ß ∑∑∑∑∑ ß ÉÄâÄÇáÄäÄÜÑÄàÄÖÅåêëîïùúûüçéíìñó                                        ß M2B3UB ß  ∑ ß
 * x metis ß ∑∑∑∑∑ ß ËÈÍÎÏÌÓÔÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ                                               ß M2ANqZ ß  ∑ ß
 * metis ß wc8∑∑ ß write interactive-use manual for metis                                 ß M1GDo1 ß  ∑ ß
 *
 */
