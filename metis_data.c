 ...
 *
 *
 * metis ß wg4-∑ ß allow forced voids for appearance, like row 18 or col 2 or 2x/4y       ß M1FDig ß  ∑ ß
 * metis ß mn4∑∑ ß trouble leaving search mode with escape, just locks for a while        ß M323rW ß  ∑ ß
 *
 *
 */
 ...
 *     a Å focus å       Å       å drive Å a  absolute      all dies without
 *       Å       å       Å       å       Å
