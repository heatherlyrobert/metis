...
/*
 * 12345 ß 12345 ß 12345678901-12345678901-12345678901-12345678901-12345678901-12345678901- ß ---beg---- ß ---end---- ß
 *
 * metis ß dw2#œ ß add data refresh command and check                                       ß 1645047879 ß 1645055000 ß
 *
 * metis ß dw2∑∑ ß add data refresh to menus                                                ß 1645047880 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß ww4-∑ ß add mark to tasks so that they can be selected to a short list           ß 1645047881 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß ww4-∑ ß allow forced voids for appearance, like row 18 or col 2 or 2x/4y         ß 1645047882 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß ww4-∑ ß add sharing flag to control database usage and marking                   ß 1645047883 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß wl4-∑ ß switch beg and end dates to pseudo-mongo (6 chars)                       ß 1645162236 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß dv2∑∑ ß when data is refreshed, the number of cards shown must be updated        ß 1645438169 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß mv4∑∑ ß add a metis field for extra data, text, and notes (variable length)      ß 1645438452 ß ∑∑∑∑∑∑∑∑∑∑ ß
 * metis ß wno∑∑ ß build central database capability                                        ß 1645438579 ß ∑∑∑∑∑∑∑∑∑∑ ß
 *
 *
 */
...
const tDECODE g_decode   [] = {
   ...
   { 's', 'œ', "archived"    , "final check before deleting in source"                        },
   /*---(done)---------------------------*/
   {  0 ,  0 , ""            , ""                                                             },
};
